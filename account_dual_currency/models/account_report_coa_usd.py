...
class AccountChartOfAccountReportUSD(models.AbstractModel):
    _name = "account.coa.report_usd"
    ...
    def _get_templates(self):
        templates = super(AccountChartOfAccountReportUSD, self)._get_templates()
    ...
    def _get_lines(self, options, line_id=None):
        ...
        accounts_results, taxes_results = self.env['account.general.ledger_usd']._do_query_usd(options_list, fetch_lines=False)
