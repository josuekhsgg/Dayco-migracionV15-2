...
class AccountMove(models.Model):
    ...
    tax_today = fields.Float(string="Tasa", default=lambda self: self._get_default_tasa())
    ...
    def create(self, vals_list):
        ...
        for payment in payments:
            if payment.move_id:
                payment.move_id._onchange_tax_today()
        return payments
    ...
    @api.depends('currency_id_dif','currency_id','amount','tax_today','aplicar_igtf_divisa')
