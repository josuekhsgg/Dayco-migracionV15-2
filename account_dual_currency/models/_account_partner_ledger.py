...
class ReportPartnerLedger(models.AbstractModel):
    ...
    _name = "account.partner.ledger_usd"
    _description = "Libro mayor de empresas USD"
    ...
    def _get_options_domain(self, options):
        ...
        if self.env.context.get('model') == 'account.partner.ledger_usd':
            domain += ['!', '&', '&', '&', ('credit_usd', '=', 0.0), ('debit_usd', '=', 0.0), ('amount_currency', '!=', 0.0), ('ref', 'ilike', 'EXCH%')]
    ...
    def _get_report_line_total(self, options, initial_balance, debit, credit, balance):
        columns = [{'name': self.format_value_usd(initial_balance), 'class': 'number'},
                   {'name': self.format_value_usd(debit), 'class': 'number'},
                   {'name': self.format_value_usd(credit), 'class': 'number'},
    ...
    def _get_report_name(self):
        return _('Libro mayor de empresa USD')
